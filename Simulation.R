...
# Load responses of survey data
kenya.resp = read.dta("KEIR72FL.DTA")
  
# Extract relevant geographical information for clusters
...
intercept = 1
sigma.sim = 1
simLoc = rbind(as.matrix(kenya.data[, c("east", "north")]),
               predCoords)
